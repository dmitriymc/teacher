...
export default function Teachers(){
    ...
    return (
        <>
         <div>
            <div class="flex flex-row"><div className="flex items-center mr-10">In the school <b className="ml-1 mr-1">4</b> teachers</div><Button className="bg-white text-blue-primary border border-blue-primary"  onClick={openModal}>New Teacher</Button></div>
        ...
        <ModalCustom isOpen={modalIsOpen} title="Create a new teacher">
            <form>
